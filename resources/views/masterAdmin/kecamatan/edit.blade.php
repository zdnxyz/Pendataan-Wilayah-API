                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <tbody>
                                <form action="{{ route('Master Adminkecamatan.update', $kecamatan->id) }}" method="POST"
                                                ...
                                                <div class="row w-100">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <small style="color: red"><b>PERHATIAN</b>: Ini berlaku jika terjadi kesalahan
                                                                menginput data.</small>
